...
test("contains the Kiwoom Ledger account dashboard", async () => {
  ...
  ]).then(([page, dashboard, route, searchRoute, sellRoute, panel, quantityControls, packageJson]) => [page, dashboard + panel, route + searchRoute + sellRoute, quantityControls, packageJson]);
